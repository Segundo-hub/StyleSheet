...
import { onMount } from "svelte";
    ...
    import { AuthContext, User, getUsers } from "../../../store";
    import UserInfo from "../../widgets/UserInfo.svelte";
    import brand_icon from './../../../assets/images/brand-icon.png'
...
<div id="nav---top" class="ui_flex_center cs--nav-top nav-top">
    <div class="brand ui_flex_center">
        <img src={brand_icon} alt="cualquiera" width="30" style="margin: 0 10px"/>
        <a class="brand-letter" href="/">StyleSheet</a>
    </div>
    <div class="items-container">
        <Link class="nav-links inline--center" to="/styles" title="styles">
        ...
        <Link class="nav-links inline--center" to="/about" title="about">
        ...
        {#if $AuthContext } 
            <span class="nav-links inline--center" on:click="{openUserInfo}" style="position: relative" role="button">
            ...
            {:else} 
             <Link class="nav-links inline--center" to="/login" title="login">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="var(--orange-200)" class="bi bi-person-circle" viewBox="0 0 16 16">
...
#nav---top{
    border-bottom: thin solid var(--orange-800);
